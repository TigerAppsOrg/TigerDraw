...
def create_tables(conn):
    ...
    # Create building
    try:
        query = 'CREATE TABLE building (room_id INT PRIMARY KEY, buiding TEXT, room_no TEXT)'
        cur.execute(query)
    except:
    ...
    for row in data2017:
        try: 
            ...
            if row:
                ...
                cur.execute('INSERT INTO draw_time VALUES(%s, %s, %s)', (get_roomid(row[0], row[1]), 2018, dt))
