...
DORMS = ['1901', '1903', '1967', '1976', '1981', '99ALEXANDER', 'Addy Hall',
         'Aliya Kanji Hall', 'BAKER', 'BLAIR', 'BLOOMBERG', 'BOGLE', 'Bosque Hall',
         'BROWN', 'BUYERS', 'CAMPBELL', 'CUYLER', 'DOD', 'EDWARDS', 'FEINBERG',
         'FISHER', 'FORBES', 'FOULKE', 'Grousbeck Hall', 'H Hall', 'HAMILTON',
         'HARGADON', 'HENRY', 'HOLDER', 'JOLINE', 'Jose Enrique Feliciano Hall',
...
SIZES = ['SINGLE', 'DOUBLE', 'TRIPLE', 'QUAD', 'QUINT', '6PERSON', '7PERSON', '8PERSON', 'DA']
# Also, what is "DA"?

COLLEGES = ['Upperclass', 'Butler College', 'Whitman College', 'Forbes College',
...
if __name__ == '__main__':
    for college in ['ButlerTimeOrder2022',
                    'ForbesDrawOrder2022',
